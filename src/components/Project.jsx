  ...
  return (
    ...
    >
      ...
      <div className="lg:w-1/2 p-4 sm:p-6 lg:p-8 flex flex-col justify-center min-h-0">
        ...
        <h3 className="text-3xl xs:text-4xl sm:text-7xl font-bold font-bebas uppercase tracking-tight text-[var(--tbba-light)] text-left mb-3 sm:mb-4 ps-0">
          {" "}
          {project.title}
        </h3>
...
const ProjectsSection = () => (
  <section
    id="projects"
    className="py-12 sm:py-16 lg:py-20 bg-[var(--tbba-dark)] w-full"
  >
